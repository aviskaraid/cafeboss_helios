...
class CreateTablePurchaseStockRequestTable extends Migration
{
    public function up(){
        // Category
        $this->forge->addField([
            ...
            'approval_date'      => ['type' => 'datetime', 'null' => true],
        ...
        $this->forge->createTable('stock_request', true);
    }

    public function down(){
        $this->forge->dropTable('stock_request');
    }
}
