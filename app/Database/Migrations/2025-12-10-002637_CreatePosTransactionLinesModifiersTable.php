...
class CreatePosTransactionLinesComboTable extends Migration
{
    public function up(){
        // Category
        $this->forge->addField([
            ...
            'line_id'               => ['type' => 'int', 'constraint' => 11, 'unsigned' => true, 'default' => 0],
            ...
            'variants'              => ['type' => 'tinyint', 'constraint' => 1, 'null' => 0, 'default' => 0],
        ...
        $this->forge->createTable('pos_transactions_lines_modifiers', true);
    }

    public function down(){
        $this->forge->dropTable('pos_transactions_lines_modifiers');
    }
}
