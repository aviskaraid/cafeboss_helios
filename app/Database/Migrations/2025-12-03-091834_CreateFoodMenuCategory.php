...
class CreateFoodMenuCategory extends Migration
{
    public function up(){
        // TABLE USER GROUPS
        $this->forge->addField([
            ...
            'sub_category_name'         => ['type' => 'varchar', 'constraint' => 100],
        ...
        $this->forge->createTable('foodmenu_category', true);
    }
    public function down(){
        $this->forge->dropTable('foodmenu_category');
    }
}
