      ...
      <div class="card gradient-bottom">
        ...
        <div class="card-body" id="top-5-scroll">
          <ul class="list-unstyled list-unstyled-border">
            <li class="media">
              <img class="mr-3 rounded" width="55" src="<?= base_url("/images/noImage.png") ?>" alt="product">
            ...
            <div>
              <div class="product-item pb-3">
                <div class="product-image">
                  <img alt="image" src="<?= base_url("/images/noImage.png") ?>" class="img-fluid">
                </div>
          ...
          <div class="row">
            <div class="col-sm-6">
              ...
              <ul class="list-unstyled list-unstyled-border list-unstyled-noborder mb-0">
                <li class="media">
                  <img class="img-fluid mt-1 img-shadow" src="<?= base_url("/images/noImage.png") ?>" alt="image" width="40">
...
<script src="<?=base_url()?>template/frequently/js/dashboard.js"></script>
<?= $this->endSection() ?>