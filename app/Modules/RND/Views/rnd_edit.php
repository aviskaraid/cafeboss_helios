  ...
  <section class="section">
    <div class="section-header">
      <div class="section-header-back">
        <a href="<?=site_url('rnd')?>" class="btn"><i class="fas fa-arrow-left"></i></a>
      </div>
      <h1>Create <?= $title ?></h1>
    </div>
    <section class="section">
        ...
        <div class="section-body">
          <div class="row">
            ...
            <div class="col-12 col-md-6 col-lg-6">
              <div class="card">
                <input type="hidden" id="rnd_id" name="rnd_id" value="<?=  $rnd->id?>">
                <div class="card-body col-md-10">
                  <div class="mb-3">
                     <label>RND Code (Generate)</label>
                      <input type="text" class="form-control d-inline-block w-75" placeholder="User Code" name="code" value="<?= $rnd->code ?>" id="department_code" readonly>
                  </div>
                  <div class="form-group">
                    <label>Description*</label>
                    <input type="text" name="description" id="descriptionInput" class="form-control" onchange="validateDescInput()" autocomplete="off" value="<?= $rnd->description ?>">
                    <input type="hidden" id="descriptionStatus" value="0">
                      <span id="descriptionFeedback" class="error-message"></span>
                  </div>
                  <div class="form-group">
                    <label>Remark</label>
                    <input type="text" name="remark" class="form-control" value="<?= $rnd->remark ?>">
                  </div>
                   <div class="form-group">
                      <label>Employee</label>
                      <input type="hidden" name="input_employee" id="input_employee" value="<?= $rnd->employee_id ?>">
...
<script src="<?=base_url()?>template/frequently/js/rnd_edit.js"></script>
