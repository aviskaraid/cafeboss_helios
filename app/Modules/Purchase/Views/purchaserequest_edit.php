...
<style>
  ...
  pointer-events: none;  /* Prevents mouse events from firing on the element itself */
                    ...
                    <div class="card-body table-responsive">
                      ...
                      <input type="hidden" value="<?= base_url()?>" name="baseUrl" id="baseUrl">
                       <input type="hidden" value="<?= $data->status?>" name="satus" id="status">
                        <input type="hidden" value="<?= $data->po_selected?>" name="po_selected" id="po_selected">
                  </div>
                  <div>
...
<script src="<?=base_url()?>template/frequently/js/purchaserequest_edit.js"></script>
