            ...
            <div class="col-12 col-md-5 col-lg-5">
              <div class="card">
                <div class="card-body col-md-10">
                  ...
                  <div class="form-group">
                    <label>Get Purchase Request No </label>
                    <input type="hidden" name="pr_id" id="pr_id">
                    <input type="hidden" name="now_date" id="now_date" value="<?= getDateNow() ?>">
                    <select class="purchase_request form-control " id="purchase_request" name="purchase_request">
                    </select>
                  </div>
                   <div class="form-group">
              ...
              <div class="card">
                <div class="card-body col-md-10" id="form_supplier">
                    ...
                    <div class="form-group">
                      ...
                      <input type="hidden" id="taktikal_status" name="taktikal">
                      <div class="custom-switches-stacked mt-2">
                        <div class="row">
                          <label class="custom-switch col-12 col-md-6 col-lg-6">
                            <input type="radio" name="taktikal" value="0" class="custom-switch-input" checked>
                            <span class="custom-switch-indicator"></span>
                            <span class="custom-switch-description">Reguler</span>
                          </label>
                          <label class="custom-switch col-12 col-md-6 col-lg-6">
                            <input type="radio" name="taktikal" value="1" class="custom-switch-input">
                            <span class="custom-switch-indicator"></span>
                     ...
                     <div class="form-group">
                        ...
                        <input type="hidden" name="input_taktikal_contract" id="input_taktikal_contract" value="0">
              ...
              <div class="card">
                <div class="card-body col-md-10" id="form_supplier">
                    <div class="form-group">
                        ...
                        <input type="text" name="transaction_date" id="transaction_date" class="transcation_date form-control" value="<?= $transaction_date ?>">
                    </div>
                    <div class="form-group">
                  ...
                  <div class="card-body col-md-10">
                    <div class="row form-group mt-4" style="display: flex;justify-content: center;align-items: center;">
                      <div class="col-12 col-md-4 col-lg-4">
                        ...
                        <div class="col-12 col-md-8 col-lg-8" style="justify-content: right;">
                          ...
                          <input type="text" name="sub_total_view" id="sub_total_view" class="form-control" style="text-align: right;" value="Rp. 0" readonly>
                      </div>
                    </div>
                     <div class="row form-group mt-4" style="display: flex;justify-content: center;align-items: center;">
                    ...
                    <div class="row form-group mt-4" style="display: flex;justify-content: center;align-items: center;">
                      <div class="col-12 col-md-4 col-lg-4">
                        ...
                        <div class="col-12 col-md-8 col-lg-8" style="justify-content: right;">
                          <input type="text" name="discount" id="discount" class="form-control" style="text-align: right;" value="0">
                      </div>
                    </div>
                     <div class="row form-group mt-4" style="display: flex;justify-content: center;align-items: center;">
                      <div class="col-12 col-md-4 col-lg-4">
                        ...
                        <div class="col-12 col-md-8 col-lg-8" style="justify-content: right;">
                          ...
                          <input type="text" name="total_view" id="total_view" class="form-control" style="text-align: right;" value="0" readonly>
                      </div>
                    </div>
                  </div>
...
<script src="<?=base_url()?>template/frequently/js/purchaseorder_create.js"></script>
