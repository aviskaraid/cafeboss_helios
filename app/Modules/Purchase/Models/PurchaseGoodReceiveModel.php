...
class PurchaseGoodReceiveModel extends Model
{
    protected $table      = 'purchase_good_receive'; // Table name
    ...
    protected $allowedFields = ["po_id","supplier_id","ref_no","remark",
                                "transaction_date","remark","status","received_by","user_id",
