...
$routes->group('master', ['filter' => 'isLoggedIn','namespace' => 'Modules\Master\Controllers'], function($routes) {
    ...
    $routes->group('itemcategory',function ($routes) {
        ...
        $routes->get('edit/(:any)', 'ItemCategoryController::edit/$1');
        $routes->patch('changes/(:any)', 'ItemCategoryController::changes/$1');
    ...
    $routes->group('items',function ($routes) {
        ...
        $routes->get('edit/(:any)', 'ItemsController::edit/$1');
        $routes->patch('changes/(:any)', 'ItemsController::changes/$1');
    ...
    $routes->group('foodmenucategory',function ($routes) {
        ...
        $routes->get('edit/(:any)', 'FoodMenuCategoryController::edit/$1');
        $routes->patch('changes/(:any)', 'FoodMenuCategoryController::changes/$1');
    ...
    $routes->group('food_menu',function ($routes) {
        ...
        $routes->post('changes/(:any)', 'FoodMenuController::changes/$1');
        $routes->post('create_process','FoodMenuController::create_process');
        $routes->get('bom/(:any)', 'FoodMenuController::bom/$1');   
        $routes->post('bom_process','FoodMenuController::bom_process');
    });
    ...
    $routes->group('supplier',function ($routes) {
        ...
        $routes->post('create_process','SupplierController::create_process');
        $routes->get('edit/(:any)', 'SupplierController::edit/$1');
        $routes->patch('changes/(:any)', 'SupplierController::changes/$1');
        $routes->get('generate_supplier_code','SupplierController::generate_supplier_code');
    });
