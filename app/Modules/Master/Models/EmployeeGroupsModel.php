...
class EmployeeGroupsModel extends Model
{
    protected $table      = 'employee_groups'; // Table name
    ...
    protected $allowedFields = ["code","name","description","active",
    ...
    public function getPaginated($num, $keyword = null, $status = 1) {
        ...
        return [
            'employeegroup' => $this->paginate($num),
            'pager' => $this->pager,
        ];
    }
}