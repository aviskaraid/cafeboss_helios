  ...
  <section class="section">
    <div class="section-header">
      <div class="section-header-back">
        <a href="<?=site_url('master/department')?>" class="btn"><i class="fas fa-arrow-left"></i></a>
      </div>
      <h1>Create <?= $title ?></h1>
    </div>
    <section class="section">
      <form id="department_create">
            ...
            <div class="col-12 col-md-6 col-lg-6">
              <div class="card">
                ...
                <div class="card-body col-md-10">
                  <div class="mb-3">
                     <label>Department Code (Generate)</label>
...
<script src="<?=base_url()?>template/frequently/js/department_create.js"></script>
