    ...
    <section class="section">
      <div class="section-header">
          ...
          <div class="section-header-button">
              <a href="<?=site_url('master/table/create')?>" class="btn btn-primary">Add New Table</a>
              <a href="<?=site_url('master/table/area')?>" class="btn btn-primary">Table Area</a>
          </div>
      </div>
      ...
      <div class="section-body">
        ...
        <div class="card card-info">
          <div class="card-body table-responsive">
            ...
            <div class="float-left">
              <i>Showing <?=empty($tables) ? 0 : 1 + (10 * ($page - 1))?> to <?=$no-1?> of <?=$pager->getTotal()?> entries</i>
            </div>
            <div class="float-right">
