              ...
              <div class="card">
                <div class="card-body col-md-10">
                  <div class="form-group">
                    <label>Name*</label>
                    <input type="text" name="name" id="nameInput" class="form-control" onchange="validateNameInput()" value="<?= $data['name'] ?>" autocomplete="off">
                    <input type="hidden" id="nameStatus" value="0">
                      <span id="nameFeedback" class="error-message"></span>
                  </div>
                  <div class="form-group">
                    <label>Description</label>
                    <input type="text" name="description" id="descriptionInput" onchange="validateDescInput()" value="<?= $data['description'] ?>" class="form-control">
                    <input type="hidden" id="descriptionStatus" value="0">
                    <span id="descriptionFeedback" class="error-message"></span>
                  </div>
                  <div class="form-group">
                    <label>Person</label>
                    <input type="number" name="person" class="form-control" step="0" value="<?= $data['person'] ?>">
                  </div>
                  <div class="form-group">
                    <label>Spesification</label>
                    <input type="text" name="spesification" class="form-control" value="<?= $data['spesification'] ?>">
                  </div>
                  <div class="form-group">
                     <label>Area</label>
