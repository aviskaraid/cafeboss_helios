    ...
    <section class="section">
      <div class="section-header">
          ...
          <div class="section-header-button">
              <a href="<?=site_url('master/employees/create')?>" class="btn btn-primary">Add New</a>
          </div>
      </div>
      ...
      <div class="section-body">
        ...
        <div class="card card-info">
          <div class="card-body table-responsive">
            <table class="table table-striped table-md">
              ...
              <tbody>
                ...
                foreach ($employee as $key => $value) : ?>
                  <tr>
                    <td><?=$no++?></td>
                    <td><?=content_wrap($value['first_name'],20)?></td>
                    <td><?=content_wrap($value['last_name'],20)?></td>
                     <td><?=content_wrap($value['department'],20)?></tdlength: >
                    <td><?=content_wrap($value['group'],20)?></td>
            ...
            <div class="float-left">
              <i>Showing <?=empty($employee) ? 0 : 1 + (10 * ($page - 1))?> to <?=$no-1?> of <?=$pager->getTotal()?> entries</i>
            </div>
            <div class="float-right">
