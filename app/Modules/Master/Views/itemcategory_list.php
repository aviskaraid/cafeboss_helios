    ...
    <section class="section">
      <div class="section-header">
          ...
          <div class="section-header-button">
              <a href="<?=site_url('master/itemcategory/create')?>" class="btn btn-primary">Add New</a>
          </div>
      </div>
      ...
      <div class="section-body">
        ...
        <div class="card card-info">
          <div class="card-body table-responsive">
            <table class="table table-striped table-md">
              ...
              <tbody>
                ...
                foreach ($itemcategory as $key => $value) : ?>
                  <tr>
                    <td><?=$no++?></td>
                    <td><?= $value['parent_id']==0 ? content_wrap($value['name'],20) : "--".content_wrap($value['name'],20) ?></td>
                    <td><?= $value['parent_id']==0 ? content_wrap($value['label_name'],20) : "--".content_wrap($value['label_name'],20) ?></td>
                    <td><?=$value['parent_name'] ?></td>
                    <td class="text-center" style="width:15%">
                        <a href="<?=site_url('master/itemcategory/edit/'.$value['id'])?>" class="btn btn-warning btn-sm" title="Permissions"><i class="fas fa-pencil-alt"></i></a>
            ...
            <div class="float-left">
              <i>Showing <?=empty($itemcategory) ? 0 : 1 + (10 * ($page - 1))?> to <?=$no-1?> of <?=$pager->getTotal()?> entries</i>
            </div>
            <div class="float-right">
