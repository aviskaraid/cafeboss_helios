            ...
            <div class="col-12 col-md-6 col-lg-6">
              <div class="card">
                <div class="card-body col-md-10">
                  <div class="mb-3">
                     <label>Supplier Code (Generate)</label>
                      <input type="text" class="form-control d-inline-block w-75" placeholder="Supplier Code" name="code" value="<?= $data->ref_code ?> ?>" id="supplier_code" readonly>
                  </div>
                  <div class="form-group">
                    <label>Name*</label>
                    <input type="hidden" id="supplier_id" name="supplier_id" value="<?= $data->id ?>">
                    <input type="text" name="name" value="<?= $data->name ?>" id="nameInput" class="form-control" onchange="validateNameInput()" autocomplete="off">
                    <input type="hidden" id="nameStatus" value="0">
                      <span id="nameFeedback" class="error-message"></span>
                  </div>
                  <div class="form-group">
                    <label>Description</label>
                    <input type="text" name="description" value="<?= $data->description ?>" id="descriptionInput" onchange="validateDescInput()" class="form-control">
                    <input type="hidden" id="descriptionStatus" value="0">
                    <span id="descriptionFeedback" class="error-message"></span>
                  </div>
                  <div class="form-group">
                    <label>Phone Number</label>
                    <input type="text" value="<?= $data->phone_number ?>" name="phone_number" id="phone_number" class="form-control">
                  </div>
                  <div class="form-group">
                    <label>Contact Name</label>
                    <input type="text" name="contact_name" value="<?= $data->contact ?>" id="contact_name" class="form-control">
                  </div>
                  <div class="form-group">
                    <label>Address</label>
                  ...
                  <div class="form-group">
                    <label>Remark</label>
                    <input type="text" name="remark" id="remark" value="<?= $data->remark ?>" class="form-control">
                  </div>
                </div>
              </div>
            </div>
...
<script src="<?=base_url()?>template/frequently/js/supplier_edit.js"></script>
