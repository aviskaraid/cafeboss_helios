                ...
                <div class="card-body col-md-10">
                  <div class="mb-3">
                     <label>Supplier Code (Generate)</label>
                      <input type="text" class="form-control d-inline-block w-75" placeholder="Supplier Code" name="code" value="<?= $generate_code ?>" id="supplier_code" readonly>
...
<script src="<?=base_url()?>template/frequently/js/supplier_create.js"></script>
