...
<?= $this->section('content') ?>
  <section class="section">
    ...
    <section class="section">
      <form id="foodmenu_create" enctype="multipart/form-data">
                    ...
                    <div class="col-12 col-md-4 col-lg-4">
                      ...
                      <div class="col-12 col-md-4 col-lg-4">
                        <div class="form-group">
                            <label></label>
                            <div class="custom-control custom-checkbox">
                              <input type="checkbox" name="modifiers" class="custom-control-input" id="modifiers">
...
<script src="<?=base_url()?>template/frequently/js/foodmenu_create.js"></script>
