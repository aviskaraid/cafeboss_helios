    ...
    <section class="section">
      <div class="section-header">
          ...
          <div class="section-header-button">
              <a href="<?=site_url('master/items/create')?>" class="btn btn-primary">Add New</a>
          </div>
      </div>
      ...
      <div class="section-body">
        ...
        <div class="card card-info">
          <div class="card-body table-responsive">
            <table class="table table-striped table-md">
              ...
              <tbody>
                ...
                foreach ($items as $key => $value) : ?>
                  <tr>
                    <td><?=$no++?></td>
                     <td style="width: 12%;"><a href="<?=site_url('master/items/edit/'.$value['id'])?>" title="Edit Data" class="font-weight-bold"><?=content_wrap($value['sku'],20)?></a></td>
            ...
            <div class="float-left">
              <i>Showing <?=empty($items) ? 0 : 1 + (10 * ($page - 1))?> to <?=$no-1?> of <?=$pager->getTotal()?> entries</i>
            </div>
            <div class="float-right">
