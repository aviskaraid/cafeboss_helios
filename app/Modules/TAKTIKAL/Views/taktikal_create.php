                ...
                <div class="card-body col-md-10">
                   <div class="mb-3">
                     <label>Taktikal Code (Generate)</label>
                      <input type="text" class="form-control d-inline-block w-75" placeholder="Taktikal Code" name="code" value="<?= $generate_code ?>" id="taktikal_code" readonly>
                      <button type="button" class="btn btn-primary d-inline-block" id="btnGenerateCode">Generate</button>
                  </div>  
                  <div class="mb-3">
                     <label>Contract Number</label>
                      <input type="text" class="form-control d-inline-block" placeholder="Contract Number" name="ref_no" id="ref_no">
                  </div>  
...
<script src="<?=base_url()?>template/frequently/js/taktikal_create.js"></script>
