      ...
      <div class="card col-md-6">
        <div class="card-body col-md-12">
            ...
            <?php $errors = session()->getFlashdata('errors'); ?>
              <form method="POST" action="<?=site_url('settings/accessmenu/create_process')?>"  method="post" autocomplete="off">
                <?= csrf_field() ?>
                <input type="hidden" value="<?= base_url()?>" name="baseUrl" id="baseUrl">
                <input type="hidden" value="0" name="parent_id" id="parent_id">
                <input type="hidden" value="0" name="main_module_id" id="main_module_id">
                <div class="form-group">
                    <label>As</label>
                    <select class="form-control select2" name="as" id="as">
                        <option value="module" selected="selected" >As Module</option>
                        <option value="function">As Function</option>
                    </select>
                </div>
