...
<li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown" class="nav-link nav-link-lg message-toggle beep"><i class="far fa-envelope"></i></a>
    ...
    <div class="d-sm-none d-lg-inline-block"><?= session()->get("user_login")->fullname?></div></a>
    <div class="dropdown-menu dropdown-menu-right">
        <div class="dropdown-title">as <?= session()->get("user_login")->groups->description?></div>
        ...
        <a href="<?=site_url('authentication/logout')?>" class="dropdown-item has-icon text-danger">
