  ...
  function initApp() {
    ...
    const app = {
      ...
      async startWithSampleData() {
        const endpoint = 'http://localhost:8080/pos/getContent'; // Or any other specific endpoint
      ...
      async reUpdateProducts() {
        ...
        for (let update of data) {
          //  const myObject = { id: update.id, name: update.name, price:update.price,
          //   option:update.option
          //   };
          //   console.log(myObject);
          //this.db.editProduct(update.id,myObject);
          //console.log(update);
        }
          //this.loadProducts();
      },
