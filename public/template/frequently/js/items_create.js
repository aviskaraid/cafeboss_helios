$(function() {
    ...
    $(document).ready(function() {
        ...
        $('.item_supplier').select2({
            multiple: true,
            placeholder: 'Search for an Item Supplier',
            ajax: {
        ...
        $('#item_supplier').on('select2:select', function (e) {
            var data = e.params.data;
            var id = data.id;
            console.log("Item Supplier "+id);
            document.getElementById("input_supplier").value=$('#item_supplier').val();
        });
         $('#item_supplier').on('select2:unselect', function (e) {
            var data = e.params.data;
            var id = data.id;
            console.log("Item Supplier "+id);
            document.getElementById("input_supplier").value=$('#item_supplier').val();
        ...
        $('#items_create').on('submit', function(e) {
             const myForm = document.querySelector('#items_create');
            e.preventDefault();
            ...
            Swal.fire({
                    ...
                    fetch(base_url +'master/items/create_process', { // Replace '/auth/login' with your CI4 login route
                        method: 'POST',
                        headers: {
