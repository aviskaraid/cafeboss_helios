$(function() {
    ...
    btnGenerate.addEventListener("click", function() {
        $.ajax({
            url:base_url + 'master/warehouse/generate_warehouse_code',
            method:"get",
            dataType:"json",
    ...
    $('#warehouse_create').on('submit', function(e) {
             const myForm = document.querySelector('#warehouse_create');
            e.preventDefault();
            ...
            Swal.fire({
                    ...
                    const data = Object.fromEntries(formData.entries());
                    fetch(base_url +'master/warehouse/create_process', { // Replace '/auth/login' with your CI4 login route
                        method: 'POST',
                        headers: {
                        ...
                        if (data.status!==200) {
                                ...
                                Swal.fire({
                                    ...
                                    Swal.fire({
                                        ...
                                        timer: 2500,
                                        willClose: () => {
                                            window.location.replace("/master/warehouse");
                                        }
                                    });
                                }
                        })
