$(function() {
    ...
    $(document).ready(function() {
        $('.item_area').select2({
            ...
            ajax: {
            url: base_url+'apis/get_pos_table_area', // The URL of your API
            dataType: 'json',
        ...
        $('#item_area').on('select2:select', function (e) {
            var data = e.params.data;
            var id = data.id;
            console.log("Item Area "+id);
            document.getElementById("input_area").value=$('#item_area').val();
        });
         $('#item_area').on('select2:unselect', function (e) {
            var data = e.params.data;
            var id = data.id;
            console.log("Item Area "+id);
            document.getElementById("input_area").value=$('#item_area').val();
    ...
    $('#table_create').on('submit', function(e) {
            const myForm = document.querySelector('#table_create');
            e.preventDefault();
            ...
            Swal.fire({
                    ...
                    fetch(base_url +'master/table/create_process', { // Replace '/auth/login' with your CI4 login route
                        method: 'POST',
                        headers: {
