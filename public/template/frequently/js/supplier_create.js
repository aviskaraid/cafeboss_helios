$(function() {
    ...
    btnGenerate.addEventListener("click", function() {
        $.ajax({
            url:base_url + 'master/supplier/generate_supplier_code',
            method:"get",
            dataType:"json",
            success: function(response) {
                document.getElementById('supplier_code').value = response;
            },
    ...
    $('#supplier_create').on('submit', function(e) {
            const myForm = document.querySelector('#supplier_create');
            e.preventDefault();
            ...
            Swal.fire({
                    ...
                    fetch(base_url +'master/supplier/create_process', { // Replace '/auth/login' with your CI4 login route
                        method: 'POST',
                        headers: {
